...
export default function TypescriptIcon({size}:SizeProps){
    return <svg xmlns="http://www.w3.org/2000/svg" className={`${sizeParameters[size]}`} x="0px" y="0px" width="60" height="60" viewBox="0 0 48 48">
