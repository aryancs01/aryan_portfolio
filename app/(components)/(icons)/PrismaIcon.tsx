import { sizeParameters, SizeProps } from ".";

export default function PrismaIcon({size}:SizeProps){
    return <svg xmlns="http://www.w3.org/2000/svg" className={`${sizeParameters[size]} bg-white px-1`} x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
